...
| `DIFY_CHAT_ENABLED`, `DIFY_CHAT_BASE_URL`, `DIFY_CHAT_APP_TOKEN`, `DIFY_CHAT_TITLE`                              | Enables the optional Dify browser chat widget. Use a browser-reachable HTTPS Dify URL and its Publish → Embed token—never a Dify service/API key. See [Dify assistant](https://docs.lihor.ro/docs/configuration/dify-assistant).                                                                                                                                                 |
