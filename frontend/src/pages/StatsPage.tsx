          ...
          <table className="w-full text-sm min-w-[480px]">
            <thead>
              <tr className="text-start text-[10px] uppercase tracking-wider text-subtle border-b border-border">
                ...
                <th className="px-3 py-2 font-medium text-end">Inserted</th>
                <th className="px-3 py-2 font-medium text-end">Skip rate</th>
                <th className="px-3 py-2 font-medium text-end">Save rate</th>
                <th className="px-3 py-2 font-medium text-end">Handle rate</th>
                <th className="px-3 py-2 font-medium text-end">Errors</th>
              </tr>
            </thead>
            <tbody>
              {loading && (
              ...
              {sourceQuality.map((s) => (
                <tr key={s.source_name} className="border-b border-border last:border-b-0">
                  ...
                  <td className="px-3 py-2 text-end tabular-nums text-star">{s.save_rate}%</td>
                  <td className="px-3 py-2 text-end tabular-nums text-muted-foreground">
                    {s.handle_rate.toFixed(1)}%
                  </td>
                  <td
                    className={`px-3 py-2 text-end tabular-nums ${s.error_rate > 0 ? 'text-err' : 'text-muted-foreground'}`}
                  >
