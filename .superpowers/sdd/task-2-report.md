...
- `test_create_lesson_failed_retry_clears_stale_extracted_fields`
- Output: `AssertionError: assert 'Stale title' is None`
...
- `pytest backend/tests/test_learn_from_link.py -q`: `13 passed, 18 warnings in 5.85s`
- `ruff check backend/news_dashboard/learn_from_link/service.py backend/tests/test_learn_from_link.py`: `All checks passed!`
